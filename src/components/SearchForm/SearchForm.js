...
const SearchForm = ({setIsShortFilmChecked, setSearchQuery, isChecked = false}) => {
    ...
    <div className="search">
      <div className="search__form-wrapper">
        <form className="search__form">
          ...
          <input className="search__input" type="search" placeholder="Фильм" onChange={handleInputChange}></input>
